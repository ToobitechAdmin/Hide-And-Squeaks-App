    ...
    return Scaffold(
      body: Container(
        ...
        decoration: BoxDecoration(
            image: DecorationImage(image: AssetImage(Customitems.textback)
                ,fit:BoxFit.fill)
        ),
        child: Padding(
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                Text("Ensuring Your Pet's \nWell-being During Play",textAlign:TextAlign.center,style: GoogleFonts.poppins(
                  fontSize: 26,
