    ...
    return Scaffold(
      body: Container(
        ...
        decoration: BoxDecoration(
          image: DecorationImage(image: AssetImage(Customitems.bluetoothbackground),fit: BoxFit.fill)
        ),
        child: Column(
          children: [
        Padding(
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    width: Get.width*0.12,
                    decoration: BoxDecoration(image: DecorationImage(image: AssetImage(Customitems.bluetooth),fit: BoxFit.fill)),
                  ),
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(image: DecorationImage(image: AssetImage(Customitems.wifi),fit: BoxFit.fill)),
                  ),
                  SizedBox(width: Get.width*0.05,),
              ...
              child: Row(
                children: [
                  Container(
                    height: Get.height*0.055,
                    width: Get.width*0.12,
                    decoration: BoxDecoration(image: DecorationImage(image: AssetImage(Customitems.bluetoothlast),fit: BoxFit.fill)),
                  ),
                  SizedBox(width: Get.width*0.05,),
                  GestureDetector(
                    onTap: (){
