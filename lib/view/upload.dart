                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                            ...
                            focusedBorder: UnderlineInputBorder(
                                borderSide: BorderSide(color: Customitems.whitecolor,width: 2)
                            ),
                            enabledBorder: UnderlineInputBorder(
                              borderSide: BorderSide(color: Customitems.whitecolor,width: 2), // Change color as needed
                            ),
                            ...
                            constraints: BoxConstraints.tightFor(height: Get.height*0.035)
                        ),
                      ),
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: Icon(Icons.file_upload_outlined,size: 50,weight: 50,color: Customitems.whitecolor,),
                                        )
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(image: AssetImage(Customitems.plublish),fit: BoxFit.fill)
                          ),
                        ),
                      ),
                                ...
                                child: InkWell(
                                  ...
                                  child: Center(
                                    child: isChecked
                                        ? Icon(
                                      Icons.check,
                                      color: Customitems.maincolor, // Set checkmark color to transparent
                                    )
