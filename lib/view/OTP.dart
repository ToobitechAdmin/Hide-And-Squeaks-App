...
class OtpScreen extends StatefulWidget {
  ...
  const OtpScreen({Key? key, required this.receivedOtp,required this.userEmail}) : super(key: key);
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                Text("OTP Code",textAlign: TextAlign.center,style:GoogleFonts.poppins(
                        ...
                        child: Padding(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              filled: true,
                              fillColor: Customitems.textfieldcolor,
                              ...
                              constraints: BoxConstraints.tightFor(width: Get.width * 0.15),
                            ),
                          ),
                        ),
                      ),
                ...
                GestureDetector(
                  onTap: () {
                    AuthController().verifyOtpAndNavigate(otpControllers, widget.receivedOtp,widget.userEmail);}, // Pass receivedOtp as an argument
