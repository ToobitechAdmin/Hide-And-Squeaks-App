...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  void initState() {
    ...
    _nameController = TextEditingController(text: controller.userData.value.petName);
    _breedController = TextEditingController(text: controller.userData.value.petBreed);
  }
    ...
    return Scaffold(
      body: Container(
        ...
        child: RefreshIndicator(
          onRefresh: () async {
            await controller.fetchUserData(); // Fetch updated data
          },
            ...
            child: Form(
              ...
              child: Column(
                children: [
                    ...
                    onTap: () {
                      ...
                      if (_profilekey.currentState?.validate() ?? false) {
                        var model = userModel(
                            ...
                            profile: controller.image.value.toString());
                  ...
                  Obx(
                    () => Text(
                      controller.userData.value.petBreed,
                      style: TextStyle(
                        fontSize: 20,
                        color: AppColors.whitecolor,
                        fontWeight: FontWeight.w500,
                  ...
                  Obx(
                    () => Text(
                      controller.userData.value.petName,
                      style: TextStyle(
                        fontSize: 20,
                        color: AppColors.whitecolor,
                        fontWeight: FontWeight.w500,
                    ...
                    () => Container(
                      ...
                      child: Image(
                        image: NetworkImage(AppUrl.imageUrl +
                            controller.userData.value.profile.toString()),
                      ),
                    ),
                  ),
                ],
